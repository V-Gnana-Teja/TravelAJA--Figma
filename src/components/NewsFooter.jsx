...
// Simplify imports by combining them into a single line
import { FaTwitter, FaInstagram, FaFacebook, FaDribbble, FaGithub } from 'react-icons/fa';
    ...
    <>
      <div className="bg-green-800 text-white mt-12">
        ...
        <div className="pl-12 p-12">
          ...
          <div className="mt-6 flex gap-3 text-4xl">
